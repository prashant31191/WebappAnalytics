...
$.fn.scaleable = function(options, Dispatcher) {
    ...
    function scaleHandler(e){
        ...
        switch(e.type) {
            ...
            case 'transformstart':
                ...
                screenOrigin = updatePointCenter(e.gesture.center.pageX, e.gesture.center.pageY);
            ...
            case 'doubletap':
                ...
                if(scale > 1){
                    ...
                    var point = updatePointCenter(e.gesture.center.pageX, e.gesture.center.pageY);
                ...
                break;
            case 'mousewheel':
                if(!options.mousewheelSupport || e.target != target[0]) return;
                target[0].style.webkitTransitionDuration = '400ms';
                target[0].style.webkitTransitionProperty = '-webkit-transform';
                var point = updatePointCenter(e.pageX, e.pageY),
    ...
    function dragHandler(e){
        ...
        if(transforming || (e.gesture && e.gesture.deltaX == 0 && e.gesture.deltaY == 0) || scale <= options.minDragableScale) return;
    ...
    function setTargetInfo(ele){
        ...
        options.doubleTapZoomIn && hammer.on('doubletap mousewheel ' + $.TOUCHSTART, scaleHandler);
    ...
    return {
        ...
        destroy: function(){
            ...
            try{
                ...
                hammer.off('doubletap mousewheel ' + $.TOUCHSTART, scaleHandler);
